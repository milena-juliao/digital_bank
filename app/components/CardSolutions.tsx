...
import { CardContainer, Demonstration, Price, Title, Divider, AvatarGroup, Avatar} from './Styled/CardSolutions.styled';
    ...
    return (
        <CardContainer onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
            <Demonstration>
                ...
                <Image src={`/icons/chart.svg`} alt='ícone de gráfico' width={20} height={20} />
            </Demonstration>
            <Divider />
            <AvatarGroup>
                {[0, 1, 2, 3].map((index) => (
                    <Avatar key={index}>
                        <Image src={`/images/section_solution_avatar${index}.png`} alt='Fotos circulares de pessoas' width={35} height={35} />
                    </Avatar>
                ))}
            </AvatarGroup>
        </CardContainer>
