...
import {
  ...
  SecureMessage,
  ErrorMessage,
} from "./Styled/FormSection.styled";
      ...
      <Form onSubmit={handleSubmit}>
        ...
        {isBusiness ? (
          <div style={{ marginBottom: "10px" }}>
            ...
            />
            {errors.cnpj && (
              <ErrorMessage>Preencha o CNPJ corretamente.</ErrorMessage>
            )}
          </div>
        ) : (
          <div style={{ marginBottom: "10px" }}>
            ...
            />
            {errors.name && (
              <ErrorMessage>Preencha o nome corretamente.</ErrorMessage>
            )}
          </div>
        )}
        ...
        <div style={{ marginBottom: "10px" }}>
          ...
          />
          {errors.email && (
            <ErrorMessage>Preencha o e-mail corretamente.</ErrorMessage>
          )}
        </div>
        ...
        <div style={{ marginBottom: "10px" }}>
          ...
          />
          {errors.phone && (
            <ErrorMessage>Preencha o celular corretamente.</ErrorMessage>
          )}
        </div>

        {/* Submit button */}
        <SubmitButton type="submit">
          {isBusiness ? "Quero para minha empresa" : "Quero ser cliente"}
        </SubmitButton>
