  ...
  const iconText = [
    {
      ...
      title: "Dúvidas?",
      text: "Envie uma mensagem para nosso time",
    },
    {
      icon: "/icons/smart_money.svg",
      title: "Faça parte",
      text: "Cadastre-se para transformar sua empresa",
    },
    {
      icon: "/icons/whatsapp.svg",
      title: "Chama no zap",
      text: "Fale com conosco comercial",
    },
  ];
        ...
        <div>
          {iconText.map((opt, index) => (
            <IconTextContainer key={index}>
              <Image src={opt.icon} alt={opt.title} width={30} height={30} />
              <div>
