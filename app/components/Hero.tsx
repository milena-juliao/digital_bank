...
import { HeroWrapper, ColumnStats, StatTitle, HeroTitle, HeroSubtitle, Divider, StatsWrapper, StatCard, StatValue, StatDescription } from './Styled/Hero.styled';
...
const Hero: React.FC = () => {
    ...
    const increaseCounter = (count: number, target: number, setState: React.Dispatch<React.SetStateAction<number>>) => {
        let current = 0;
    ...
    return (
        <HeroWrapper>
            <ColumnStats>
                ...
                <HeroSubtitle>Pellentesque rutrum turpis non est turpis pretium morbi urna.</HeroSubtitle>
                <Divider />
                <StatsWrapper>
                    <StatCard>
                        <motion.div
